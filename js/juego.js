...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var primerNumero = grilla[filaPos1][columnaPos1];
  var segundoNumero = grilla[filaPos2][columnaPos2];
  grilla[filaPos1][columnaPos1] = segundoNumero;
  grilla[filaPos2][columnaPos2] = primerNumero;
}
